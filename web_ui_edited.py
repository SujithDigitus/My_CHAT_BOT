...
if user_query is not None and user_query.strip() != "":
    ...
    with st.chat_message("AI", avatar="🕵️‍♂️"):
        with st.spinner("Wait! Let me think....."):
            ...
            # Enhanced RAG pipeline call - now returns response and relevant images analyzed by Gemini 2.5 Flash
            ...
            # Display only the relevant images that Gemini 2.5 Flash has determined as relevant
            if relevant_images:
                print(f"Displaying {len(relevant_images)} relevant images analyzed by Gemini 2.5 Flash")
                images_displayed = 0
                ...
                for img_path in relevant_images:
                    ...
                    try:
                        if img_path and os.path.exists(img_path):
                            ...
                            st.image(image, caption=f"Relevant Image: {os.path.basename(img_path)}")
                            images_displayed += 1
                ...
                print("No relevant images found by Gemini 2.5 Flash analysis")
